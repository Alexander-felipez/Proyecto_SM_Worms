...
export const GAME_CONFIG = {
    ...
    PLAYER: {
        ...
        MOVE_SPEED: 3,
        JUMP_FORCE: -8,
        FALL_DEATH_Y: 640,       // Y donde el jugador "cae al agua" y muere
        HP_BAR_WIDTH: 40,
        HP_BAR_HEIGHT: 5,
    ...
    // --- TURNOS ---
    TURN: {
        DURATION: 30000,          // 30 segundos por turno
    ...
    WEAPONS: {
        ...
        // Armas futuras (Fase 2)
        // GRANADA: { name: 'Granada', damage: 50, radius: 80, speed: 0.03, ammo: 3, fuse: 3000 },
        // SHOTGUN: { name: 'Escopeta', damage: 25, radius: 20, speed: 0.08, ammo: 2, spread: 3 },
    },
    ...
    WIND: {
        MIN: -0.005,
        MAX: 0.005,
        ENABLED: false, // Se habilitará en Fase 2
    },
