...
export class TurnManager extends Phaser.Events.EventEmitter {
    ...
    /**
     * Llamado cuando el jugador inicia el disparo. Bloquea disparos adicionales y detiene el temporizador.
     */
    onPlayerFired() {
        if (!this.isTurnActive) return;
        this.hasFired = true;
        this.timeRemaining = 0; // Terminar el tiempo, pero esperamos a que resuelva el proyectil
    }

    /**
     * Llamado cuando la acción del proyectil termina (explosión o fuera de mapa).
     */
